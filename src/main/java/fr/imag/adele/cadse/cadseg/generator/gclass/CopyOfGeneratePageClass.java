...
/**
 * The Class CopyOfGeneratePageClass.
 * 
 * @author <a href="mailto:stephane.chomat@imag.fr">Stephane Chomat</a>
 */
public class CopyOfGeneratePageClass extends GenerateClass {
	...
	public static void generate(ContextVariable cxt, Item page) {
		...
		ret = new CopyOfGeneratePageClass(cxt, pn, cn, super_pn + "." + super_cn, javatype);
		ret.id = page.getName();
		ret.page = page;
	...
	/**
	 * Instantiates a new copy of generate page class.
	 * 
	 * @param cxt
	 *            the cxt
	 * @param packageName
	 ...
	 *            the type
	 */
	private CopyOfGeneratePageClass(ContextVariable cxt, String packageName, String className,
